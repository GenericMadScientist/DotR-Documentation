 ...
 */
extern Model* gSzModel_ahModel[84];

/** @brief Gets the type of the specified model.
 *
 *  If slot is not between 0 and 83 inclusive, or if gSzModel_ahModel[slot] is
 *  the NULL pointer, then this function returns -1 instead.
 *
 *  @param slot The index of the pointer in models
 *  @return gSzModel_ahModel[slot]->type
 */
